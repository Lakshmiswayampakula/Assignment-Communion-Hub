      ...
      <div className="w-full max-w-xs md:max-w-md mx-auto mt-2 md:mt-4 mb-3 md:mb-6"
        ...
        <div className="relative">
          <input
            ...
            className={`w-full pl-3 pr-10 md:pl-4 md:pr-12 py-2 md:py-3 bg-white/20 backdrop-blur-lg rounded-full border border-white/30 text-white text-sm md:text-base placeholder-white/70 shadow-lg focus:outline-none focus:${ringColor} transition-all duration-300`}
          />
